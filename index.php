...
<head>
	...
	<meta name="title" content="个人站">
	<meta name="author" content="个人站-免费发布">
	<meta name="description" content="个人站，免费资源分享！">
	<meta name="keywords" content="个人站,资源下载">
...
<body>
	<!--<audio style="opacity:0 ;" src="./m.mp3" controls="controls" loop autoplay preload="auto"></audio> -->
	<!-- 电脑PC端 -->
	<div id="pc">
		<div id="content">
			<!-- 内容左侧选择区域 -->
			<ul id="cleft">
				<div class="cleft_top">
					<div class="cleft_topbg">
						<div class="cleftbg_img"><img src="img/tx.png" alt="头像"></div>
					</div>
					<div class="cleftbg_p">无聊无聊无聊无聊</div>
				</div>
				...
				<li id="cleft_li06" onclick="AddFavorite('肥鸟论坛',location.href)"><img
						src="font/cnmsb06.png" /><span>收藏本站</span></li>
			...
			<div id="cright">
				...
				<div id="nav01">
					<div class="nav01_left">
						<div class="nav01_logo">
							...
							<h4>个人站</h4>
							<h4><span>linweizhuo.github.io</span></h4>
						</div>
						<div class="nav01_wz">
							<h5>初次见面！</h5>
							<h1>欢迎来到</h1>
				...
				<div id="nav02">
					...
					<div class="nav02_kj" style="height: 600px;">
						...
						<div class="nav02_grzl_headimg">
							<img src="img/tx.png" alt="[头像]">
							<a href="https://space.bilibili.com/1641862471" target="_blank"
								rel="noopener noreferrer">联系站长</a>
						</div>
						<div class="nav02_grzl_txt">
							<p>网名：蓝瓶钙，好喝的钙</p>
							<p>邮箱：3112608992@qq.com</p>
							<p>性别：boy</p>
							<p>年龄：未知</p>
							<p>特长：没特长</p>
							<p>爱好：未知</p>
					...
					<div class="nav02_kj">
						...
						<p>
							本人代码风骚，效率恐怖。C，java，html,css无不精通，熟练掌握各种框架。
						</p>
						<p>
						...
						<p>
							不喷人，操作虎，意识强，渗透快，shell多，能过狗，能过盾。
						</p>
						<p>
							出Bug后，秒登vpn，千里之外定位问题，瞬息之间修复上线。
						</p>
						<p>
							只有你想不到的，没有我做不到的。
						</p>
						<p>
							以上都是瞎吹的，我只会划水摸鱼，我是个废物，勿喷，233333
						</p>
						<p>
							&nbsp;
						</p>
						<h3>😁网站的艰难运行环境</h3>
						<p>
							主页托管在Github上，速度相对较慢，请耐心等待，哈哈哈哈哈哈哈嗝~
						</p>
						<p>
							&nbsp;
						</p>
				...
				<div id="nav03">
					<div class="enav03_p">
						<h3 style="font-size: 10px;">https://space.bilibili.com/109969908<span>黄页工作室</span></h3>
						<h5>划水摸鱼，闲无止境~</h5>
						<p>2020-2022</p>
				...
				<div id="nav04">
					...
					<div class="nav04_zsc">
						<div>
							<p>商业合作 - B站二维码</p>
							<img src="img/wx.png" alt="[企业微信二维码]" title="[企业微信二维码]">
						</div>
						<p>即使夜深人静，我们依然在努力！</p>
					</div>
				</div> -->
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo "<strong>时间：</strong>" . $row["created_at"];
                echo "</p>";
                echo "</div>";
            }
        } else {
...
<div class="form-container">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <textarea name="message" id="message" class="input-field" rows="4" cols="50" required></textarea><br>
        		...
        		<!-- 作品展示模板NO1 --
						<div class="nav05_centent_mb">
							<a href="https://space.bilibili.com/109969908" target="_blank" rel="noopener noreferrer">
						...
						-- 作品展示模板NO2 --
						<div class="nav05_centent_mb">
							<a href="https://www.3ffn.com" target="_blank" rel="noopener noreferrer">
						...
						-- 作品展示模板NO3 --
						<div class="nav05_centent_mb">
							<a href="https://www.3yzy.cn/" target="_blank" rel="noopener noreferrer">
						...
						-- 作品展示模板NO5 --
						<div class="nav05_centent_mb">
							<a href="http://www.tv.3yzy.com/" target="_blank" rel="noopener noreferrer">
					...
					<p class="nav05_footer">你有有趣或实用的站点推荐嘛？~</p>
				</div>
				...
				<div id="nav07">
					...
					<div class="nav07_kj">
						<h3>😁写/在/前/面</h3>
						<p>
							此源码全开源发布，转载还请保留版权信息（三月工作室）！
						</p>
						<p>
							官方网站：<a href="https://space.bilibili.com/109969908">https://space.bilibili.com/109969908</a>
						</p>
						<p>
							源码下载：<a href="http://wpa.qq.com/msgrd?v=3&uin=33656708&site=qq&menu=yes">看视频简介</a>
					...
					-- 到底了-提示 --
					<p class="ebpx7">--- 如果有好的想法或建议，可发送至站长邮箱(admin@3yzy.com)，期待您的来信---</p>
				</div>
			</div>
			...
			<div id="exnav02">
				...
				<div class="exn02_zl">
					...
					<div class="exn02_kjt">
						...
						<p>
							本人代码风骚，效率恐怖。C/C＋＋，java，php无不精通，熟练掌握各种框架。
						</p>
						<p>
							会DDOS一秒钟死一个站，会注入，会上传，会Xss，会破解，会嗅探，会开发，会业务，会运维，会渗透。互联网内，我无处不在。
						</p>
						...
						<p>
							脾气好，不喷人，操作虎，意识强，渗透快，shell多
						</p>
						<p>
							出Bug后，千里之外定位问题，瞬息之间修复上线。
						</p>
						<p>
							只有你想不到的，没有我做不到的。
						</p>
						<p>
							以上都是吹的，我只会划水摸鱼，我是个废物,hhhhhhh
						</p>
						<p>
							&nbsp;
						</p>
